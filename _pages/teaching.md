...
<table>
  ...
  <tbody>
    <tr>
      <td>Graduate Teaching Assistant (Lab Instructor)</td>
      <td>
        Prepared and delivered weekly lab sessions linking field sampling and analytical methods to core course concepts; 
        supervised students during experiments and data analysis; 
        designed and graded lab reports and in-class assignments; 
        held office hours for technical and project support; 
        coordinated and facilitated three local site visits to connect lab content with real-world practice.
      </td>
    </tr>
  </tbody>
</table>
